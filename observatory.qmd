...
![You can visit the Open Music Observatory on <https://openmusicobservatory.eu/>. For API-level access get in touch with [Reprex](https://reprex.nl/contact/).](png/OMO/20260302_OPENMUSE_WP5_Final_v2_overview.png){fig-align="center"}
...
![The four layers of European interoperability: legal, organisational, semantic and technological in our federated Slovak module.](png/OMO/data_sharing_space_eif_schema.png){fig-align="center"}
...
[^observatory-19]: *Music, Heritage, and Policy in the Age of AI* [@antal_diversity_pillar_2025]. (In the OpenMusE project it was Deliverable D2.3.)
