...
The *Europeana Data Model* (EDM) was designed for library holdings and is well suited to printed works, but it cannot capture the attribution needs of recorded music, which must identify at least three groups of rightsholders: authors, producers, and performers.[^observatory-7] The *ECCCH report* likewise overlooked music entirely, focusing instead on monuments, archaeology, textiles, and museums.[^observatory-8] Its first projects — such as **AUTOMATA**, **TEXTaiLES**, **HERITALISE**, and **ECHOES** — developed advanced tools for other heritage assets, but none addressed music directly. Our own attempts to include music datasets in ECHOES’ cascading grants illustrate the problem: proposals were screened out early, despite the clear need for music representation.

[^observatory-7]: The EDM builds on DCTERMS, which works well for printed music but not for recordings. It fails to capture neighbouring rights such as those of producers and performers [@EDM_2017].

[^observatory-8]: *Ex–ante impact assessment on the European Collaborative Cloud for Cultural Heritage* [@eccch_report_2022]. The first ECCCH pilots (AUTOMATA, TEXTaiLES, HERITALISE, ECHOES) focused on archaeology, textiles, and monuments, leaving music out.
...
[^observatory-13]: On official adoption: EU Knowledge Graph [@diefenbach_wikibase_2021]; SEMIC guidelines [@semic_support_centre]. On Belgian pilots: *MetaBelgica* [@meta_belgica_project] and Flemish performing arts enrichment [@magnus_podiumkunsten_2021].
...
[^observatory-17]: Our definition here is an extended paraphrase of [@curry_dataspaces_2020] and reflects that a "data \[sharing\] space is an ecosystem of exchange, processing, sharing and provision of data between trusted partners, for a fee or not" from [@dataspace_for_cci_2022, p16].
