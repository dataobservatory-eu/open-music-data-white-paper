...
Generative AI is threatening the livelihoods and existing rights of rightsholders. The *Open Music Europe* consortium did not study generative AI in-depth, our initial focus was on untrustworthy use of agentic AI[^ai-terms]. We want to highlight again our analysis from @sec-curation that metadata is never neutral.


[^ai-terms]: The term *agentic AI* refers to AI systems that operate with some degree of autonomy
and goal-directed behaviour. In academic and technical contexts, this covers **agent-based
frameworks** (where AI systems act in an environment, plan, and adapt), which can be applied
either to **generative models** (e.g. creating music or images) or to **workflow automation**
(e.g. metadata correction, licensing negotiation). By contrast, recommender systems such as
collaborative filtering — widely used in music platforms — are not agentic, since they do not act
independently of user input. We retain the shorthand “agentic AI” in this Green Paper for
accessibility, but recognise that multiple sub-classes of AI systems are involved.
...
**Responsible AI Music framework**, ensuring that sector-specific practices in Europe are
consistent with emerging international standards.[^raim]

[^raim]: The *Responsible AI Music framework* (RAIM) sets out principles for transparency,
fairness, sustainability, and accountability in the use of AI in music [@raim_2025].
Several of the codes of conduct proposed here — such as clarity around data provenance,
safeguards for attribution, and limits on exploitative recommendation practices — align closely
with RAIM’s recommendations. Where RAIM defines broad principles, this _Green Paper_ provides
concrete mechanisms for their operationalisation within European music data spaces and observatories.
...
-   **Inclusiveness** — minority repertoires, independent artists, and small markets must be equally visible alongside the global catalogues of multinational platforms. Our Finno-Ugric case studies show how fragile metadata can be repaired without erasing community perspectives — a model that must be embedded at Observatory scale[^ai-4].

[^ai-4]: We have created the second federated module of the Open Music Observatory with contemporary popular and authentic folk music of European Finno-Ugric minorities who do not have a nation state. [@finnougric_2025]
