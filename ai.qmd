...
Generative AI is threatening the livelihoods and existing rights of rightsholders, and xxxxx. The *Open Music Europe* consortium did not study generative AI in-depth, our initial focus was on untrustworthy use of agentic AI. xxxx and the xxxx offers a great overview and an initiative to make generative AI . We want to highlight again our analysis from @sec-curation that metadata is never neutral.
...
- **Inclusiveness** — minority repertoires, independent artists, and small markets must be equally visible alongside the global catalogues of multinational platforms. Our Finno-Ugric case studies show how fragile metadata can be repaired without erasing community perspectives — a model that must be embedded at Observatory scale^[finnougric].

^[finnougric]: We have created the second federated module of the Open Music Observatory with contemporary popular and authentic folk music of European Finno-Ugric minorities who do not have a nation state. [@finnougric_2025]
