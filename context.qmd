...
The CITF report, based on the *Study on copyright and new technologies: copyright data management and artificial intelligence*, defines a structured approach to future copyright infrastructures through three layers (foundational, semantic, technical). The solution pathways proposed in this Green Paper can be mapped onto these layers: identifier governance corresponds to the foundational layer; pragmatic ontology patterns map to the semantic layer; and federated pipelines align with the technical layer. See for further details the @sec-citf in the Annex.
:::
